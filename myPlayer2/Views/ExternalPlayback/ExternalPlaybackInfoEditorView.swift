...
struct ExternalPlaybackInfoEditorView: View {
    ...
    var body: some View {
        TrackInfoEditorCore(
            ...
            genreTagsText: .constant(""),
            language: .constant(""),
            labelOrCompany: .constant(""),
            releaseDateText: .constant(""),
            qqMusicSongMid: .constant(""),
            metadataSource: .constant(""),
            metadataFetchedAt: .constant(nil),
            metadataConfidence: .constant(nil),
