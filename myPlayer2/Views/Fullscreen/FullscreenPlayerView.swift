    ...
    private func applyFullscreenLyricsTheme(force: Bool = false, reason: String = "") {
        ...
        let readyCoverBlurTheme = isCoverBlurFullscreenSkin
            ? lyricsThemeEngine.updateCoverBlurLyricsThemeIfReady(
                for: currentTrack,
                currentTheme: coverBlurLyricsTheme,
        ...
        if let readyCoverBlurTheme {
            ...
            if themeChanged {
                coverBlurLyricsTheme = readyCoverBlurTheme
            }
        }
        ...
        let colorSet = activeCoverBlurTheme?.colors
            ?? lyricsThemeEngine.makeFullscreenLyricsColorSet(
                ...
                lockedBackgroundColor: lockedFullscreenLyricsBackgroundColor,
                lockedUltraDark: lockedFullscreenLyricsUltraDark,
                pendingBackgroundCapture: pendingFullscreenLyricsBackgroundCapture,
        ...
        var config = lyricsThemeEngine.buildFullscreenLyricsConfig(
            ...
            isFullscreenBottomControlsVisible: isFullscreenBottomControlsVisible
        )
