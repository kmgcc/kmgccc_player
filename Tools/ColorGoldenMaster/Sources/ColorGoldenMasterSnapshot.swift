...
enum ColorGoldenMasterSnapshot {
    ...
    private static func appendAnalysis(_ analysis: ArtworkColorAnalysis, to lines: inout [String]) {
        ...
        lines.append("analysis.foreground_polarity: \(ArtworkForegroundPolarityPolicy.globalPolarity(avgHslLightness: analysis.avgHslLightness, weightedLuma: analysis.weightedLuma, avgBrightness: analysis.avgBrightness, avgSaturation: analysis.avgSaturation).rawValue)")
        lines.append("analysis.foreground_gate_reason: \(ArtworkForegroundPolarityPolicy.globalGateReason(avgHslLightness: analysis.avgHslLightness, weightedLuma: analysis.weightedLuma, avgBrightness: analysis.avgBrightness, avgSaturation: analysis.avgSaturation).rawValue)")
        lines.append("analysis.bright_area_ratio: \(ColorGoldenMasterSupport.f(analysis.brightAreaRatio))")
        lines.append("analysis.dark_area_ratio: \(ColorGoldenMasterSupport.f(analysis.darkAreaRatio))")
